...
#ifndef WEISLAM_FIGURE_H
#define WEISLAM_FIGURE_H
...
namespace cvplot{
    ...
    public:
        ...
        bool legend() const;
        Color color() const;
        void draw(void *buffer, float x_min, float x_max, float y_min, float u_max,
    ...
    public:
        Figure(View &view)
            : view_(view),
              ...
              aspect_sqaure_(false),
              grid_size_(60),
              grid_padding_(20){}

        Figure &clear();
        Figure &origin(bool x, bool y);
        Figure &sqaure(bool square);
