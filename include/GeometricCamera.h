...
#ifndef WEISLAM_GEOMETRICCAMERA_H
#define WEISLAM_GEOMETRICCAMERA_H
...
namespace WeiSLAM{
    ...
    public:
        ...
        virtual bool ReconstructWithTwoViews(const std::vector<cv::KeyPoint>& vKeys1, const std::vector<cv::KeyPoint>& vKeys2, const std::vector<int> &cMatches12,
        ...
        virtual bool matchAndtriangulated(const cv::KeyPoint& kp1, const cv::KeyPoint& kp2, GeometricCamera* pOther,
...
#endif //WEISLAM_GEOMETRICCAMERA_H
